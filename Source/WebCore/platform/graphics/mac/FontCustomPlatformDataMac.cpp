...
FontPlatformData FontCustomPlatformData::fontPlatformData(const FontDescription& fontDescription, bool bold, bool italic, const FontCreationContext& fontCreationContext)
{
    ...
    unrealizedFont.modify([shouldAllowUserInstalledFonts = fontDescription.shouldAllowUserInstalledFonts()](CFMutableDictionaryRef attributes) {
        addAttributesForWebFonts(attributes, shouldAllowUserInstalledFonts);
    });
